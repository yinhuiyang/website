module.exports = function layout() {
    ...
    $('.list-group > li').css('width', 'calc('+taskWidth+' - 20px)')
    $('.interior-item').css('width', '100%')
    // $('.title-font').css({'maxWidth': 'calc(100% - 65px)'})
    var nodeWidth = $(".list-group>li").outerWidth(true)
    ...
    $('.list-group').css({'height': maxSumHeight+'px'})
